...
Once you've got that done you'll want to modify the file to include all the settings for your RetroPopulator jig setup. The example file contains documentation on how to use its various settings.
